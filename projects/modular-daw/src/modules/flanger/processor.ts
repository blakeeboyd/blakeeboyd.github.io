...
export const flangerFactory: ProcessorFactory = {
  create(ctx: AudioContext, params: Record<string, number>): ProcessorInstance {
    ...
    // Wet path: short modulated delay with feedback
    const delayNode = ctx.createDelay(0.02);
    delayNode.delayTime.value = 0.003; // base delay
