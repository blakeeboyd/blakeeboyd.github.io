...
export function SplitterModuleNode({ id, data }: NodeProps<DawNode>) {
    ...
    <div className={nodeClasses}>
      ...
      <div className="daw-node__body">
        <div className="daw-node__port-labels">
          <span className="daw-node__port-label daw-node__port-label--right">L</span>
          <span className="daw-node__port-label daw-node__port-label--right">R</span>
        </div>
      </div>
